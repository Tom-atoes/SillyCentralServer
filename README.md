...
Now install the `.mrpack` file from [here](https://drive.google.com/file/d/1U4f6shZ1G_KTegAKRX2CCgybcBxruFFn/view?usp=sharing) (pack is in the zip file, extract it).
